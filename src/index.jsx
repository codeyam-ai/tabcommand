...
// `chrome.storage.local` (backed by localStorage, codeyam's seed inlet) plus
// no-op action stubs. This replaces the reference App.jsx's `sinon-chrome`
// fallback; in a packaged extension the native `chrome` wins and it is inert.
