# TabCommand — Chrome Web Store upload guide (Public listing, v0.16)
...
|---|---|---|
| `tabcommand-0.16.zip` | The packaged extension (manifest at the zip root, version **0.16**) | Package → Upload new package |
...
2. Click **"Add new item"** and upload **`tabcommand-0.16.zip`**.
3. **Store listing** tab:
